...
utils: pdfdetach pdffonts  pdfimages pdfinfo pdfseparate pdftohtml pdftoppm pdftops pdftotext pdfunite ;

%:
	cp ${UTIL_PATH}/$@ ${UTIL_PATH}/$@.bc
	emcc -O2 -minify 1 --pre-js ./toolbox-base/pre.js ${UTIL_PATH}/$@.bc ${ZLIB} ${FREETYPE} ${FONTCONFIG} ${LIBPNG} ${LIBJPEG} ${LIBTIFF} -o $@-worker.js
